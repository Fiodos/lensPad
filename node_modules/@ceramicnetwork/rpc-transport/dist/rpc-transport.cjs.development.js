      ...
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              res = transport.pipe(operators.first(function (res) {
...
function createHandlerOperator(context, methods, options) {
  ...
  return rxjs.pipe(operators.mergeMap( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(req) {
...
function serve(transport, context, methods, options) {
  return transport.pipe(createHandlerOperator(context, methods, options), operators.filter(function (res) {
    return res != null;
  })).subscribe(transport);
}

exports.createClient = createClient;
exports.createHandlerOperator = createHandlerOperator;
exports.createSendRequest = createSendRequest;
exports.serve = serve;
//# sourceMappingURL=rpc-transport.cjs.development.js.map
