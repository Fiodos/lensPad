...
var addFormats = _interopDefault(require('ajv-formats'));
var SecureSchema = _interopDefault(require('ajv/lib/refs/json-schema-secure.json'));
...
function decodeDagJWSResult(_ref3) {
  ...
  return {
    ...
    linkedBlock: uint8arrays.fromString(linkedBlock, 'base64pad')
  };
}
function encodeDagJWSResult(_ref4) {
  ...
  return {
    ...
    linkedBlock: uint8arrays.toString(linkedBlock, 'base64pad')
  };
}
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            _context.next = 6;
            return streamTile.TileDocument.create(ceramic, content, metadata);
        ...
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            return createTile(ceramic, definition, {
              schema: idxConstants.schemas.Definition
            });
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 2:
            ...
            if (!(loaded.metadata.schema !== idxConstants.schemas.Definition)) {
              _context4.next = 5;
              break;
            }
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.next = 3;
            return streamTile.TileDocument.createFromGenesis(ceramic, genesis, PUBLISH_OPTS);
...
function addSchema(records, schema, options) {
  ...
  var title = changeCase.pascalCase(providedTitle);
  ...
  if (schema.type === 'array' && schema.items != null) {
    ...
    if (schema.$id === SCHEMA_REF_ID) {
      ...
      records.objects[name] = Object.entries(schema.properties).reduce(function (acc, _ref) {
        ...
        var key = _ref[0],
            value = _ref[1];
        var prop = changeCase.camelCase(key);
        var opts = {
...
exports.SCHEMA_REF_ID = SCHEMA_REF_ID;
exports.applyMap = applyMap;
exports.createDefinition = createDefinition;
exports.createIDXDefinitions = createIDXDefinitions;
exports.createIDXSignedDefinitions = createIDXSignedDefinitions;
...
exports.docIDToString = docIDToString;
...
exports.publishEncodedSignedDocSet = publishEncodedSignedDocSet;
exports.publishIDXConfig = publishIDXConfig;
exports.publishIDXSignedDefinitions = publishIDXSignedDefinitions;
exports.publishIDXSignedSchemas = publishIDXSignedSchemas;
exports.publishSchema = publishSchema;
exports.publishSignedDocSet = publishSignedDocSet;
exports.publishSignedMap = publishSignedMap;
exports.schemas = schemas;
exports.signIDXDefinitions = signIDXDefinitions;
exports.signIDXSchemas = signIDXSchemas;
exports.signTile = signTile;
exports.signedDefinitions = signedDefinitions;
exports.signedSchemas = signedSchemas;
...
//# sourceMappingURL=idx-tools.cjs.development.js.map
