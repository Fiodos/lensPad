...
describe('XX Fallback Handshake', () => {
    ...
    it('should test that both parties can fallback to XX and finish handshake', async () => {
        try {
            ...
            const handshakeResp = new XXFallbackHandshake(false, respPayload, prologue, stablelib, staticKeysResponder, connectionTo, initialMsgR, peerA);
            ...
            const handshakeInit = new XXFallbackHandshake(true, handshakePayload, prologue, stablelib, staticKeysInitiator, connectionFrom, initialMsgI.slice(0), peerB, ephemeralKeys);
...
//# sourceMappingURL=xx-fallback-handshake.spec.js.map